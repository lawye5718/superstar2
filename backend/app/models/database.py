...
class PackageTemplateRule(Base):
    ...
    template_id = Column(String(36), ForeignKey("prompts.id"), nullable=True)
...
class GenerationTask(Base):
    ...
    template_id = Column(String(36), ForeignKey("prompts.id"), nullable=False)
    ...
    # Result
    result_gallery_id = Column(String(36), ForeignKey("user_galleries.id"), nullable=True)
...
class UserGallery(Base):
    ...
    id = Column(String(36), primary_key=True, default=generate_uuid)
    user_id = Column(String(36), ForeignKey("users.id"), nullable=False, index=True)
    template_id = Column(String(36), ForeignKey("prompts.id"), nullable=False, index=True)
...
class Like(Base):
    ...
    gallery_item_id = Column(String(36), ForeignKey("user_galleries.id"), primary_key=True)
    created_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False)
...
class Order(Base):
    ...
    template_id = Column(String(36), ForeignKey("prompts.id"), nullable=True)  # 添加模板ID
